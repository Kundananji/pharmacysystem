...
<div class="mb-3">
  <button class="btn btn-primary" onclick="Menu.addNewMenuMenus_admin({<?php echo sizeof($arguments)>0?(implode(",",$arguments)):null ?>})" id="add-new-menu-menus_admin"><em class="fa fa-plus"></em> Add New Menu </button>
</div>
<table class="table table-striped" id="table-menu--menus_admin">
  <thead>
    <tr>
      <th>
        No.
