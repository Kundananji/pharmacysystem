...
<div class="mb-3">
  <button class="btn btn-primary" onclick="Users.addNewUsersUsers_admin({<?php echo sizeof($arguments)>0?(implode(",",$arguments)):null ?>})" id="add-new-users-users-admin"><em class="fa fa-plus"></em> Add New  </button>
</div>
<table class="table table-striped" id="table-users--users-admin">
  <thead>
    <tr>
      <th>
        No.
