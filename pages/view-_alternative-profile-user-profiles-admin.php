...
<div class="mb-3">
  <button class="btn btn-primary" onclick="AlternativeProfile.addNewAlternativeProfileUserprofiles_admin({<?php echo sizeof($arguments)>0?(implode(",",$arguments)):null ?>})" id="add-new-_alternative-profile-user-profiles-admin"><em class="fa fa-plus"></em> Add New User Profile </button>
</div>
<table class="table table-striped" id="table-_alternative-profile--user-profiles-admin">
  <thead>
    <tr>
      <th>
        No.
