...
?>
 <h1 class="h3 mb-4 text-gray-800">Manage Other Fees</h1>  
<table class="table table-striped" id="table-invoice-detail--other-fees-pharamacy-user">
  <thead>
    <tr>
      <th>
        No.
  ...
  <tbody>
    ...
    ?>
      ...
      <th>
        ...
        <td>
        <?php
          echo '<a href="javascript:void(0)" class="btn btn-danger" onclick="InvoiceDetail.deleteInvoiceDetailOtherfees_pharamacyuser('.$invoiceDetail->getId().' )">  <em class="fa fa-trash"></em> </a>';
        ?>
        </td>
      </tr>
    <?php
