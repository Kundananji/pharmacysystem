...
<div class="mb-3">
  <button class="btn btn-primary" onclick="Profile.addNewProfileProfiles_admin({<?php echo sizeof($arguments)>0?(implode(",",$arguments)):null ?>})" id="add-new-_profile-profiles_admin"><em class="fa fa-plus"></em> Add New Profile </button>
</div>
<table class="table table-striped" id="table-_profile--profiles_admin">
  <thead>
    <tr>
      <th>
        No.
