...
$dao = new PrivilegeDao();
 ...
 $objects = $dao->selectAll();
             ?>
             <h1 class="h3 mb-4 text-gray-800">Privilege</h1>  
<div class="mb-3"><button class="btn btn-primary" onclick="Privilege.addNewPrivilege({})" id="add-new-privilege"><em class="fa fa-plus"></em> Add New Privilege </button></div>
<table class="table table-striped" id="table-privilege">
  <thead>
    <tr>
      <th>
      </th>
  ...
  <tbody>
    ...
    ?>
      ...
      <th>
        ...
        <td>
        <?php
          echo '<a href="javascript:void(0)" class="btn btn-danger" onclick="Privilege.deletePrivilege('.$privilege->getId().' )"><em class="fa fa-trash"></em></a>';
        ?>
        </td>
      </tr>
    <?php
