...
<div class="mb-3"><button class="btn btn-primary" onclick="Status.addNewStatus({})" id="add-new-status"><em class="fa fa-plus"></em> Add New Status </button></div>
  ...
  <tbody>
    ...
    ?>
      ...
      <th>
        ...
        <td>
        <?php
          echo '<a href="javascript:void(0)" class="btn btn-danger" onclick="Status.deleteStatus('.$status->getId().' )"><em class="fa fa-trash"></em></a>';
        ?>
        </td>
      </tr>
    <?php
