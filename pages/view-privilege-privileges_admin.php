...
<div class="mb-3">
  <button class="btn btn-primary" onclick="Privilege.addNewPrivilegePrivileges_admin({<?php echo sizeof($arguments)>0?(implode(",",$arguments)):null ?>})" id="add-new-privilege-privileges_admin"><em class="fa fa-plus"></em> Add New Privilege </button>
</div>
<table class="table table-striped" id="table-privilege--privileges_admin">
  <thead>
    <tr>
      <th>
        No.
