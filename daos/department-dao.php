...
/**
* function to insert single object of type Department into database
* @param object instance of type Department
* @return inserted objected of type Department
*/
  public function insert($department){
    ...
    try{
      $sql="INSERT INTO department(`id`,`name`,`description`) VALUES(?,?,?)";
      ...
      $insertedDepartment = $this->getFields($row);
        $stmt->close();
...
/**
* function to update single object of type Department
* @param object instance of type Department
* @return updated objected of type Department
*/
  public function update($department){
    ...
    try{
      ...
      while($row=$result->fetch_assoc()){
        $updatedDepartment = $this->getFields($row);
        $stmt->close();
...
/**
* function to select array of object of type Department from database through the provided search term
* @return array of objects of type Department
*/
  public function search($term,$searchFields,$extra=null,$pageSize=0,$pageNo=null){
    ...
    try{
      $sql="SELECT * FROM department WHERE (".implode(' OR ',$whereClause).") ".($extra!=null?("AND ".$extra):'')." $limitClause";
      $stmt=Database::getConnection()->prepare($sql);
      $stmt->execute();
      $result = $stmt->get_result();
      $objects = array();
      while($row=$result->fetch_assoc()){
        $department = $this->getFields($row);
        $objects[]=$department;
      }
      $stmt->close();
      return $objects;
...
/**
* function to select array of object of type Department from database
* @return array of objects of type Department
*/
  public function selectAll($pageSize=0,$pageNo=null){
    ...
    try{
      $sql="SELECT * FROM department $limitClause";
      $stmt=Database::getConnection()->prepare($sql);
      $stmt->execute();
      $result = $stmt->get_result();
      $objects = array();
...
/**
* function to select single instance of object of type Department from database
* @return object of type Department
*/
  public function select($departmentId){
    try{
      $sql="SELECT * FROM `department` WHERE `id`=?";
      $stmt=Database::getConnection()->prepare($sql);
...
*/
  public function selectBy($fields,$values,$types,$orderByFields=array(),$pageSize=0,$pageNo=null){
    ...
    try{
      $sql="SELECT * FROM department  WHERE ".implode(" AND ",$whereVars) .(sizeof($orderByFields)>0?("ORDER BY ".implode(",",$orderByFields)):"")." $limitClause";
      $stmt=Database::getConnection()->prepare($sql);
      $stmt->execute();
      $result = $stmt->get_result();
      $objects = array();
...
/**
* function to delete a single instance of object of type Department from database
* @return boolean
*/
...
*/
  public function selectByWhereClause($whereClause){
    try{
      $sql="SELECT * FROM department  WHERE ".$whereClause;
      $stmt=Database::getConnection()->prepare($sql);
      $stmt->execute();
      $result = $stmt->get_result();
      $objects = array();
...
*/
  public function getFields($row){
    $department= new Department();
      ...
      $department->setDescription($row['description']);
    return $department;
  }
}
