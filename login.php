<?php 
  session_start();include("config/database.php");include("config/authentication.php"); $authentication = new Authentication();$userLoggedIn = $authentication->isUserLoggedIn();$user = null;
...
<head>
  ...
  <!-- customized styles for login page -->
  <style type="text/css">
  .bg-login-image {
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Welcome To HMS</h1>
                  </div><form class="user">
                    ...
                    <div class="form-group">
                      ...
                      <a href="javascript:void(0)" id="link-login" class="btn btn-primary btn-user btn-block">
                        Login
                      </a> 
                  </form>
                  <hr>
                  <div class="text-center">
                    <a class="small" href="javascript:void(0)" id="link-reset-password">Forgot Password?</a>
                  </div>
                  <div class="text-center">
