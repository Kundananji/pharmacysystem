...
?>
<form onsubmit = "Receipt.submitFormReceiptViewreceipt_pharamacyuser(event,{<?php echo sizeof($arguments)>0?(implode(",",$arguments)):null ?>})" method="post" enctype="multipart/form-data" action="#" id="form-receipt">
