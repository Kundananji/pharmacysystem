...
if(isset($id)){
  $tempObject = $patientsEditDao->select($id);
  if($tempObject !=null){
...
<div class="alert alert-info">Fields marked with an asterisk(*) are required.</div>
  ...
  <input type="hidden" name="id" id="input-patients-id" value="<?php echo null!==($patientsEdit->getId())?($patientsEdit->getId()):(isset($defaultValues['id'])?($defaultValues['id']): "0");?>"/>
...
<div class="form-group input-patients-file-id">
                 ...
                 <?php
                  ...
                  if($patientsEdit->getId()!=null){ $defaultValues['fileId']=$patientsEdit->getFileId();};
                  ?>
...
<div class="form-group input-patients-first-name">
                 ...
                 <?php
                  ...
                  //override default value with actual value if object is sent
                  if($patientsEdit->getId()!=null){ $defaultValues['firstName']=$patientsEdit->getFirstName();};
                  ?>
...
<div class="form-group input-patients-other-names">
                 ...
                 <?php
                  ...
                  //override default value with actual value if object is sent
                  if($patientsEdit->getId()!=null){ $defaultValues['otherNames']=$patientsEdit->getOtherNames();};
                  ?>
...
<div class="form-group input-patients-last-name">
                 ...
                 <?php
                  ...
                  //override default value with actual value if object is sent
                  if($patientsEdit->getId()!=null){ $defaultValues['lastName']=$patientsEdit->getLastName();};
                  ?>
...
<div class="form-group input-patients-address">
                 ...
                 <?php
                  ...
                  //override default value with actual value if object is sent
                  if($patientsEdit->getId()!=null){ $defaultValues['address']=$patientsEdit->getAddress();};
                  ?>
...
<div class="form-group input-patients-contact-number">
                 ...
                 <?php
                  ...
                  //override default value with actual value if object is sent
                  if($patientsEdit->getId()!=null){ $defaultValues['contactNumber']=$patientsEdit->getContactNumber();};
                  ?>
...
<div class="form-group input-patients-nationality">
                 ...
                 <?php
                  ...
                  //override default value with actual value if object is sent
                  if($patientsEdit->getId()!=null){ $defaultValues['nationality']=$patientsEdit->getNationality();};
                  ?>
...
<div class="form-group input-patients-status">
                 ...
                 <?php
                  ...
                  //override default value with actual value if object is sent
                  if($patientsEdit->getId()!=null){ $defaultValues['status']=$patientsEdit->getStatus();};
                  ?>
