...
?>
<form onsubmit = "InvoiceDetail.submitFormInvoiceDetailOtherfees_pharamacyuser(event,{<?php echo sizeof($arguments)>0?(implode(",",$arguments)):null ?>})" method="post" enctype="multipart/form-data" action="#" id="form-invoice-detail">
...
?>
 ...
 <!--start of form group-->
<div class="form-group d-none input-invoice-detail-medicine-id">
