...
//assign global fields current values
  ...
  $.ajax({
    url: "pages/view-_profile-profiles_admin.php",
    type: "post",
    data:data,
    success: (data)=>{
      divPageContent.html(data);
      $('#table-_profile--profiles_admin').DataTable({});
    }
  });
  };
let addNewProfileProfiles_admin=(data)=>{
  ...
  $.ajax({
    url: "forms/_profile-profiles_admin-form.php",
    type: "get",
    data: data, 
    success: (data)=>{
 ...
 let submitFormProfileProfiles_admin = (e,args) =>{
  ...
  $.ajax({
    url: "scripts/submit-_profile-profiles_admin-form.php",
    type: "post",
    dataType:"json",
    data:data,
    success: (resp)=>{
